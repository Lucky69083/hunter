...
DEAD_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/15b7c17ecd2d7e65094fc.jpg"
  

DEADLY = "✯ HOTSPOT 𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲 ✯\n\n"
DEADLY += f"═══════════════════\n"
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                 ...
                                 buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/HOTSPOTXMUSIC"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/HOTSPOTXMUSIC")
        ],
        [
